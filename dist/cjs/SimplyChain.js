...
exports.SimplyChain = void 0;
var SimplyBlock_1 = require("./SimplyBlock");
var SimplyChain = /** @class */ (function () {
    ...
    SimplyChain.prototype.createGenesisBlock = function () {
        ...
        var previous_hash = '0';
        var block = new SimplyBlock_1.SimplyBlock(index, timestamp, data, previous_hash);
        block.mineSync();
        var hash = block.hash();
    ...
    SimplyChain.prototype.createBlock = function () {
        ...
        this._pendingBlock = new SimplyBlock_1.SimplyBlock(index, timestamp, transactions, lastblock.hash());
...
exports.SimplyChain = SimplyChain;
